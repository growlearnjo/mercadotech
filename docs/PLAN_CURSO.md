> **Nota de contexto (sesión 7).** Este documento es el **plan maestro del
> curso**: lo que estaba previsto construir, sesión por sesión. Vivía en el
> README de la raíz hasta la Fase 7.5, cuando ese sitio pasó a ocuparlo el
> README **del producto**, escrito para alguien que llega al repositorio sin
> saber nada del curso.
>
> Se conserva **intacto**, sin editar un párrafo: es el plan, y su valor está
> justamente en poder contrastarlo con lo que de verdad se construyó. Para eso
> están [`BITACORA.md`](BITACORA.md) (lo que pasó en cada sesión, con sus
> desviaciones) y [`ARQUITECTURA.md`](ARQUITECTURA.md) (lo que hay hoy en el
> código). Ante cualquier contradicción entre este plan y el código, **gana el
> código**.
